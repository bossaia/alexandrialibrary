        ...
        private void MapProperties(Type type)
        {
            foreach (var property in type.GetProperties(BindingFlags.Public | BindingFlags.Instance))
            {
                ...
                if (!ignore)
                {
                    ...
                    {
                        //System.Diagnostics.Debug.WriteLine("EntityInfo.MapProperties: property name=" + property.Name + " type=" + property.PropertyType.Name + " IsSimpleType=" + property.PropertyType.IsSimpleType());
