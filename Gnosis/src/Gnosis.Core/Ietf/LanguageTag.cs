...
namespace Gnosis.Core.Ietf
{
        ...
        : ILanguageTag
    {
        ...
        private static void InitializeGrandfatheredTags()
        {
            ...
            grandfatheredTags.Add("en-gb-oed", new Tuple<ILanguage, ICountry>(Language.English, Iso.Country.UnitedKingdom));
            ...
            grandfatheredTags.Add("zh-min", new Tuple<ILanguage, ICountry>(Language.Chinese, Iso.Country.Taiwan));
                            ...
                            case 2:
                                {
                                    ...
                                    {
                                        country = Iso.Country.GetCountryByCode(token);
                                    }
                                    break;
                                }
                            case 3:
                                {
                                    ...
                                    else
                                    {
                                        if (int.TryParse(token, out regionCode))
                                            region = UN.Region.GetRegionByCode(regionCode);
                                        else
                            ...
                            case 4:
                                {
                                    ...
                                    {
                                        script = Iso.Script.GetScriptByCode(token);
                                    }
                                    break;
                                }
                            case 5:
