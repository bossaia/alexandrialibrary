      ...
      protected override void MediaPlayerEventOccured(ref libvlc_event_t libvlc_event, IntPtr userData)
      {
         switch (libvlc_event.type)
         {
            case libvlc_event_e.libvlc_MediaMetaChanged:
               ...
               {
                  metaDataChanged(m_eventProvider, new MediaMetaDataChange((MetaDataType)libvlc_event.media_meta_changed.meta_type));
               }
            ...
            case libvlc_event_e.libvlc_MediaSubItemAdded:
               ...
               {
                  BasicMedia media = new BasicMedia(libvlc_event.media_subitem_added.new_child, ReferenceCountAction.AddRef);
            ...
            case libvlc_event_e.libvlc_MediaDurationChanged:
               ...
               {
                  durationChanged(m_eventProvider, new MediaDurationChange(libvlc_event.media_duration_changed.new_duration));
               }
            ...
            case libvlc_event_e.libvlc_MediaParsedChanged:
               ...
               {
                  parsedChanged(m_eventProvider, new MediaParseChange(Convert.ToBoolean(libvlc_event.media_parsed_changed.new_status)));
               }
            ...
            case libvlc_event_e.libvlc_MediaFreed:
               if (mediaFreed != null)
               {
                  mediaFreed(m_eventProvider, new MediaFree(libvlc_event.media_freed.md));
               }
            ...
            case libvlc_event_e.libvlc_MediaStateChanged:
               ...
               {
                  stateChanged(m_eventProvider, new MediaStateChange((MediaState)libvlc_event.media_state_changed.new_state));
               }
