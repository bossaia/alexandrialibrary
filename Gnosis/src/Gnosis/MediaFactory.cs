...
namespace Gnosis
{
        ...
        //: IMediaFactory
    {
        public MediaFactory()
        {
            ...
            //AddFactoryFunction(MediaType.ImageBmp, (location, type) => new BitmapImage(location, type));
            //AddFactoryFunction(MediaType.ImageGif, (location, type) => new GifImage(location, type));
            //AddFactoryFunction(MediaType.ImageJpeg, (location, type) => new JpegImage(location, type));
            //AddFactoryFunction(MediaType.ImagePng, (location, type) => new PngImage(location, type));

            //AddFactoryFunction(MediaType.TextHtml, (location, type) => new XhtmlDocument(location, type));
            //AddFactoryFunction(MediaType.TextPlain, (location, type) => new PlainText(location, type));

            //AddFactoryFunction(MediaType.VideoAvi, (location, type) => new AviVideo(location, type));
            //AddFactoryFunction(MediaType.VideoMpeg, (location, type) => new MpegVideo(location, type));
            //AddFactoryFunction(MediaType.VideoMpeg4, (location, type) => new Mpeg4Video(location, type));
            //AddFactoryFunction(MediaType.VideoWmv, (location, type) => new WmvVideo(location, type));
        }
