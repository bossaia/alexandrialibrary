...
namespace Gnosis.Data
{
    public class DatabaseBatch<T>
        ...
        where T : IEntity
    {
        public DatabaseBatch(IEntityCache<T> cache, IEntityStore<T> database, IDbConnection connection, bool useTransaction)
        {
            if (cache == null)
        ...
        private readonly IEntityCache<T> cache;
        ...
        private void DeleteTag(T entity, ITag tag)
        {
        ...
        private void SaveTag(T entity, ITag tag)
        {
