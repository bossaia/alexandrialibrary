...
namespace Gnosis.Culture
{
        ...
        : ILanguageTag
    {
        ...
        public static readonly ILanguageTag Empty = new LanguageTag(Language.Undetermined, Geography.Country.Unknown);
        ...
        private static void InitializeGrandfatheredTags()
        {
            ...
            grandfatheredTags.Add("en-gb-oed", new Tuple<ILanguage, ICountry>(Language.English, Geography.Country.UnitedKingdom));
            ...
            grandfatheredTags.Add("zh-min", new Tuple<ILanguage, ICountry>(Language.Chinese, Geography.Country.Taiwan));
