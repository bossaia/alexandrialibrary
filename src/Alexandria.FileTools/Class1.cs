...
namespace AlexandriaOrg.Alexandria.FileTools
{
			...
			try
			{
				...
				using (FileStream stream = new FileStream(path, FileMode.Open))
				{
					...
					if (header[0] == 0x4F && header[1] == 0x67 && header[2] == 0x67 && header[3] == 0x53)
						contentType = new ContentType("application/ogg");
					...
					//0      4                    0x49 0x44 0x33 0x2|0x3
						...
						contentType = new ContentType("audio/mp3");
					//0      16                   0x30 0x26 0xB2 0x75 0x8E 0x66 0xCF 0x11 0xA6 0xD9 0x00 0xAA 0x00 0x62 0xCE 0x6C
						...
						contentType = new ContentType("video/x-ms-asf"); //"audio/x-ms-wma"; //ASF GUID: F8699E40-5B4D-11CF-A8FD-00805F5C442B
