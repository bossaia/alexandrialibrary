...
Finally, flip this setup card over and place it next to the quest deck. Its effect remains active throughout the game, which is now ready to begin.",
                ...
                UpdateScenarioCards = (groups) =>
                {
                    ...
                    {
                        var scenario = group.Scenarios.Where(x => x.Title == "Conflict at the Carrock").FirstOrDefault();
                        if (scenario == null)
                            continue;
            ...
            Cards.Add(new Card()
            {
                ...
                HitPoints = 10,
                Traits = new List<string> { "Troll." },
                Keywords = new List<string> { "Immune to player events." },
                Text = "While Morris is in the victory display, each Troll enemy gets +1 Attack and gains \"Immune to player events.\".",
                VictoryPoints = 2,
                EncounterSet = "Conflict at the Carrock Nightmare",
                Quantity = 1,
                Number = 5,
            ...
            Cards.Add(new Card()
            {
                ...
                HitPoints = 10,
                Traits = new List<string> { "Troll." },
                Keywords = new List<string> { "Rupert's Defense cannot be reduced." },
                Text = "While Rupert is in the victory display, the Defense of each Troll enemy cannot be reduced.",
                VictoryPoints = 2,
                EncounterSet = "Conflict at the Carrock Nightmare",
                Quantity = 1,
                Number = 6,
            ...
            Cards.Add(new Card()
            {
                ...
                HitPoints = 10,
                Traits = new List<string> { "Troll." },
                Keywords = new List<string> { "Cannot have player attachments." },
                Text = "While Stuart is in the victory display, each Troll enemy gets +1 Defense and gains \"Cannot have player attachments.\"",
                VictoryPoints = 2,
                EncounterSet = "Conflict at the Carrock Nightmare",
                Quantity = 1,
                Number = 7,
