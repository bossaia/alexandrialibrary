    ...
    public class TheThreeTrials : CardSet
    {
        protected override void Initialize()
        {
            ...
            Cards.Add(new Card()
            {
                ...
                Text = "Attached character gets +2 hit points and gains sentinel.",
            ...
            Cards.Add(new Card()
            {
                ...
                Keywords = new List<string> { "Attach to a Scout hero." },
                Text = "While attached character is committed to the quest, place 1 progress on the first location revealed by the encounter deck each round.",
...
Players cannot defeat this stage unless Hallowed Circle is in the victory display. If the players defeat this stage, they win the game.",
            ...
            Cards.Add(new Card()
            {
                ...
                Keywords = new List<string> { "Cannot have non-Key attachments.", "Time 2." },
                Text = "Forced: After the last time counter is removed from Boar's Guardian, the engaged player must discard an ally he controls. Place 2 time counters on Boar's Guardian.",
                VictoryPoints = 3,
                EncounterSet = "The Three Trials",
                Number = 40,
            ...
            Cards.Add(new Card()
            {
                ...
                Keywords = new List<string> { "Cannot have non-Key attachments.", "Time 3." },
                Text = "Forced: After the last time counter is removed from Wolf's Guardian, it makes an immediate attack against the engaged player. Place 3 time counters on Wolf's Guardian.",
                VictoryPoints = 3,
                EncounterSet = "The Three Trials",
                Number = 41,
            ...
            Cards.Add(new Card()
            {
                ...
                Keywords = new List<string> { "Cannot have non-Key attachments.", "Time 4." },
                Text = "Forced: After the last time counter is removed from Raven's Guardian, deal 1 damage to each character controlled by the engaged player. Place 4 time counters on Raven's Guardian.",
                VictoryPoints = 3,
                EncounterSet = "The Three Trials",
                Number = 42,
                Artist = Artist.Darek_Zabrocki
