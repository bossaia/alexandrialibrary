...
{
    public class RidingWithRohan : Deck
    {
        public RidingWithRohan()
            : base("Riding with Rohan", "http://talesfromthecards.wordpress.com/2012/12/28/deck-spotlight-riding-with-rohan/")
        {
            DeckList =
@"Eowyn (Core) x1
Dunhere (Core) x1
