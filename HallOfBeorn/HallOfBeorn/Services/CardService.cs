    ...
    public class CardService
    {
        ...
        private void LoadCategories()
        {
            var filters = new List<Func<Card, Category>>
            {
                ...
                CreateCategoryFilter(@"deal[\s]([\d]|X)*[\s]damage|Deal damage to the attacking enemy|Excess damage dealt by this attack is assigned", Category.Direct_Damage, "1 damage to Erkenbrand"),
