...
namespace Gnosis.Tests2
{
        ...
        : SQLiteDatabase<Artist>
    {
        ...
        protected override void LoadEntity(IDataRecord record, Action<uint, Artist> entityLoaded)
        {
...
create unique index if not exists Artist_unique on Artist (Name, Year);";
        ...
        protected override IStep GetInsertEntityStep(Artist entity)
        {
        ...
        protected override IStep GetUpdateEntityStep(uint id, Artist entity)
        {
