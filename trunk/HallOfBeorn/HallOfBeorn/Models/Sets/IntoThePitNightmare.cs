...
Finally, flip this setup card over and place it next to the quest deck. Its effect remains active throughout the game, which is now ready to begin.",
                ...
                UpdateScenarioCards = (groups) =>
                {
                    ...
                    {
                        var scenario = group.Scenarios.Where(x => x.Title == "Into the Pit").FirstOrDefault();
                        if (scenario == null)
                            continue;
...
Progress cannot be placed on ~Goblin Ambush expect by the above effect.",
            ...
            Cards.Add(new Card()
            {
                ...
                HitPoints = 4,
                Traits = new List<string> { "Goblin.", "Orc." },
                Text = "Cannot be optionally engaged.\r\n\r\nIf the active location is a Dark location, Goblin Lurker gets +3 Attack and -40 enagement cost.",
