...
namespace Gnosis.Video.Vlc
{
    ...
    public partial class VideoPlayerControl
        : System.Windows.Controls.UserControl, IVideoPlayer, INotifyPropertyChanged
    {
        ...
        private VideoPlaybackState playbackState = VideoPlaybackState.None;
        ...
        {
            get { return playbackState == VideoPlaybackState.Playing ? Visibility.Collapsed : Visibility.Visible; }
        }

        public Visibility PauseVisibility
        {
            get { return playbackState == VideoPlaybackState.Playing ? Visibility.Visible : Visibility.Collapsed; }
        }
