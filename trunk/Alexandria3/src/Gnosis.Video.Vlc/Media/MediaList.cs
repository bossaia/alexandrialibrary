...
namespace Gnosis.Video.Vlc.Media
{
   internal class MediaList : DisposableBase, IMediaList, INativePointer, IEventProvider, IReferenceCount
   {
      ...
      #region IList<IVlcMedia> Members
      ...
      public IVlcMedia this[int index]
      {
         get
         {
            using (new MediaListLock(m_hMediaList))
      ...
      #region ICollection<IVlcMedia> Members
      ...
      #region IEnumerable<IVlcMedia> Members

      public IEnumerator<IVlcMedia> GetEnumerator()
      {
         throw new NotImplementedException();
      }
