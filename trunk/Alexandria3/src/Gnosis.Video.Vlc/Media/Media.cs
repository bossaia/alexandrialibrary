...
namespace Gnosis.Video.Vlc.Media
{
   internal class BasicMedia : DisposableBase, IVlcMedia, INativePointer, IReferenceCount, IEventProvider
   {
      ...
      #region IEqualityComparer<IVlcMedia> Members
      ...
      {
         return this.Equals((IVlcMedia)obj, this);
      }
