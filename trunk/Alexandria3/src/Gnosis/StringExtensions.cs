    ...
    public static class StringExtensions
    {
        ...
        public static string ToAmericanizedString(this string self)
        {
            ...
            var wordsToNormalize = new Dictionary<string, string> {
                {"THE", string.Empty}, {"A", string.Empty}, {"OF", string.Empty}, {"AT", string.Empty}, {"AND", string.Empty}, {"IN", string.Empty}, {"WITH", string.Empty}, {"BUT", string.Empty}, {"OR", string.Empty}, {"FOR", string.Empty},
        ...
        public static string ToUrlEncodedString(this string self)
        {
            ...
            var escaped = new StringBuilder(self);
            escaped.Replace("%", "%25");
