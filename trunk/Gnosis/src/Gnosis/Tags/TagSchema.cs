...
namespace Gnosis.Tags
{
        ...
        : ITagSchema
    {
        ...
        public static readonly ITagSchema Default = new TagSchema(1, "Default", Algorithms.Algorithm.Default);
        public static readonly ITagSchema Americanized = new TagSchema(21, "Americanized", Algorithms.Algorithm.Americanized);
        public static readonly ITagSchema Id3v1 = new TagSchema(101, "ID3v1", Algorithms.Algorithm.Default);
        public static readonly ITagSchema Id3v2 = new TagSchema(102, "ID3v2", Algorithms.Algorithm.Default);
