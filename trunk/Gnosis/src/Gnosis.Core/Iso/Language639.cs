...
namespace Gnosis.Core.Iso
{
        ...
        : ILanguage639
    {
        private Language639(string alpha3Code, string name)
            : this(string.Empty, alpha3Code, name)
        {
        }

        private Language639(string alpha2Code, string alpha3Code, string name)
        {
        ...
        /// <summary>
        /// The 3-letter alphabetical code for ISO 639-2
        /// </summary>
        ...
        public static IEnumerable<ILanguage639> Languages
        {
        ...
        public static readonly Language639 Afar = new Language639("aa", "aar", "Afar");
        public static readonly Language639 Abkhazian = new Language639("ab", "abk", "Abkhazian");
