...
namespace Gnosis.Video.Vlc
{
    ...
    public interface IMediaPlayerFactory : IDisposable
    {
        ...
        T CreatePlayer<T>() where T : IVlcPlayer;
        ...
        T CreateMedia<T>(string input, params string[] options) where T : IVlcMedia;
        ...
        T CreateMediaListPlayer<T>(IMediaList mediaList) where T : IVlcMediaListPlayer;
