...
namespace Gnosis.Video.Vlc.Players
{
   internal class MediaListPlayer : DisposableBase, IVlcMediaListPlayer, IEventProvider
   {
      private IntPtr m_hMediaListPlayer = IntPtr.Zero;
      private IVlcVideoPlayer m_videoPlayer;
      ...
      public IVlcVideoPlayer InnerPlayer
      {
         get
         {
      ...
      public bool Equals(IVlcPlayer x, IVlcPlayer y)
      {
      ...
      public int GetHashCode(IVlcPlayer obj)
      {
