...
namespace Gnosis.Tests.Unit.Data.SQLite
{
    ...
    public class SavedTracks
    {
        ...
        private ITrack track1 = new GnosisTrack("Paranoid Android", 2, TimeSpan.FromSeconds(220), new Uri(radioheadUrn), "Radiohead", new Uri(okComputerUrn), "OK Computer", new Uri("file:///audio/radiohead/paranoid_android.mp3"), MediaType.AudioMpeg, Guid.Empty.ToUrn(), "Administrator", new Uri("http://example.com/image1.jpg"));
        private ITrack track2 = new GnosisTrack("Sober", 4, TimeSpan.FromSeconds(306), Guid.NewGuid().ToUrn(), "Tool", Guid.NewGuid().ToUrn(), "Undertow", new Uri("file:///audio/tool/sober.mp3"), MediaType.AudioMpeg, Guid.Empty.ToUrn(), "Administrator", new Uri("http://example.com/image2.jpg"));
        private ITrack track3 = new GnosisTrack("Maybe Not", 7, TimeSpan.FromSeconds(189), Guid.NewGuid().ToUrn(), "Cat Power", Guid.NewGuid().ToUrn(), "Free", new Uri("file:///audio/cat_power/maybe_not.mp3"), MediaType.AudioMpeg, Guid.Empty.ToUrn(), "Administrator", new Uri("http://example.com/image3.jpg"));
        private ITrack track4 = new GnosisTrack("Silence", 5, TimeSpan.FromSeconds(423), Guid.NewGuid().ToUrn(), "PJ Harvey", Guid.NewGuid().ToUrn(), "White Chalk", new Uri("file:///audio/pj_harvey/paranoid_android.mp3"), MediaType.AudioMpeg, Guid.Empty.ToUrn(), "Administrator", new Uri("http://other.org/blah.png"));
        private ITrack track5 = new GnosisTrack("Airbag", 1, TimeSpan.FromSeconds(291), new Uri(radioheadUrn), "Radiohead", new Uri(okComputerUrn), "OK Computer", new Uri("file:///audio/radiohead/airbag.mp3"), MediaType.AudioMpeg, Guid.Empty.ToUrn(), "Administrator", new Uri("file:///some-stuff/blah/ph.jpg"));
