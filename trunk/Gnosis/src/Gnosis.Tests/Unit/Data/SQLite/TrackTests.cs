...
namespace Gnosis.Tests.Unit.Data.SQLite
{
    ...
    public class SavedTracks
    {
        ...
        private ITrack track2 = new GnosisTrack("Sober", DateTime.MinValue, DateTime.MaxValue, 4, TimeSpan.FromSeconds(306), Guid.NewGuid().ToUrn(), "Tool", Guid.NewGuid().ToUrn(), "Undertow", new Uri("file:///audio/tool/sober.mp3"), MediaType.AudioMpeg, Guid.Empty.ToUrn(), "Administrator", new Uri("http://example.com/image2.jpg"), new byte[0]);
        private ITrack track3 = new GnosisTrack("Maybe Not", DateTime.MinValue, DateTime.MaxValue, 7, TimeSpan.FromSeconds(189), Guid.NewGuid().ToUrn(), "Cat Power", Guid.NewGuid().ToUrn(), "Free", new Uri("file:///audio/cat_power/maybe_not.mp3"), MediaType.AudioMpeg, Guid.Empty.ToUrn(), "Administrator", new Uri("http://example.com/image3.jpg"), new byte[0]);
