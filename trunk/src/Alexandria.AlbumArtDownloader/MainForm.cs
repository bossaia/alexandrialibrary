...
namespace Alexandria.AlbumArtDownloader
{
	...
	public delegate void DelegateAddThumb(ThumbRes res);
	...
	public delegate void DelegatePreviewGot(Image i, ThumbRes thumb);
	...
	public partial class MainForm : Form
	{
		...
		public void RemoveThumbs()
		{
			...
			{
				ThumbRes r = new ArtDownloader.ThumbRes();
		...
		public void callbackAddThumb(ThumbRes r)
		{
			AddThumb(r);
		}
		public ListViewItem AddThumb(ThumbRes res)
		{
		...
		public void ThumbClicked(ThumbRes res, bool usedefsave)
		{
		...
		public void PreviewGot(Image i, ThumbRes s)
		{
		...
		private void ShowPreview(Image image, ThumbRes title)
		{
		...
		private void checkFolder(string FolderName)
		{
			...
			for (long i = filesInfo.LongLength - 1; i >= 0; i--)
			{
				...
				//TODO: figure out how to remove the dependency on ATL.*
				/*
